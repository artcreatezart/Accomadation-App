...
$(document).ready(function () {
    ...
    $( document ) .on ( 'click', '#bookButton', function () {
        const accomodationData = $( this ).data ( 'id') ;
        const filteredAccomodation = filteredAccomodationData [ accomodationData ] ;
        const diffDays = calculateDays();
        ...
        populateBookingInfoOutput ( filteredAccomodation );
        ...
        const slideBookingOutputHtml = ` 
            <div class="booking-info-container">
              ...
              <div class="booking-info-section">
                <h4>Accomadation:</h4>
                ${ accomodation && accomodation.name ? `<h3> ${ accomodation.name } </h3>` : ''}
              </div>
