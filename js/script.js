...
$ ( document ) .ready ( function () {
  ...
  // Validation of Filters with error messages
  ...
  // Filter and display accomadations Function
  ...
  // Calculate days using date picker
  ...
  function displayAccomadations ( filteredAccomadations ) {
    ...
    // Card populate from filter of accomadations
